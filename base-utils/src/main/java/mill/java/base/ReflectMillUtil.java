...
public class ReflectMillUtil {
     ...
     * @return
     */
    public static <T> T constructorNewInstance(Class<T> classes,Object ...args){
        if (ObjectMillUtil.isNull(args)){
            return null;
        }
        ...
        Class[] parameterTypes=  classList.toArray(new Class[classList.size()]);
        return  constructorNewInstance(classes,parameterTypes,args);
    }
    ...
    public static <T> String compareBeanValue(Map<String, String> fileds, T oldBean, T newBean) {
        ...
        for (Map.Entry<String, String> entity : fileds.entrySet()) {
            ...
            if (StringMillUtil.isEmpty(oldPropertyValue + "")) {
                oldPropertyValue = " ";
            }
            compares.append(oldPropertyValue).append("\"现属性值\"");
            if (StringMillUtil.isEmpty(newPropertyValue + "")) {
                newPropertyValue = " ";
            }
